<div class="pokemon-attribute-container">
  <img src="../../img/pokemon/florges.png" width="100"/>
...
=== "Level Up Moves"
    | Level | Name | Power | Accuracy | PP | Type | Damage Class |
        | -- | -- | -- | -- | -- | -- | -- |
        	| 1 | Petal-dance | 120 | 100 | 10 | ![grass](../img/types/grass.png) | ![special](../img/types/special.png) |
	| 1 | Aromatherapy | - | - | 5 | ![grass](../img/types/grass.png) | ![status](../img/types/status.png) |
	| 1 | Flower-shield | - | - | 10 | ![fairy](../img/types/fairy.png) | ![status](../img/types/status.png) |
	| 1 | Disarming-voice | 40 | - | 15 | ![fairy](../img/types/fairy.png) | ![special](../img/types/special.png) |
	| 1 | Petal-blizzard | 90 | 100 | 15 | ![grass](../img/types/grass.png) | ![physical](../img/types/physical.png) |
	...
	| 1 | Lucky-chant | - | - | 30 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 1 | Wish | - | - | 10 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 1 | Grassy-terrain | - | - | 10 | ![grass](../img/types/grass.png) | ![status](../img/types/status.png) |
