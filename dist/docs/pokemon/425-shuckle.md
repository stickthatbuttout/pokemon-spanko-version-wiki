<div class="pokemon-attribute-container">
  <img src="../../img/pokemon/shuckle.png" width="100"/>
...
<table style="width: 100%">
  <tbody style="width: 100%;">
    ...
    <tr style="display: flex; align-items: center;">
      ...
      <td style="width: 100%; min-width: 450px; border-top: none;">
        <div style="width: 90%;" class="ranking-bar rank-6">
        </div>
      </td>
    </tr>
    <tr style="display: flex; align-items: center;">
    ...
    <tr style="display: flex; align-items: center;">
      ...
      <td style="width: 100%; min-width: 450px; border-top: none;">
        <div style="width: 1%;" class="ranking-bar rank-1">
        </div>
      </td>
    </tr>
  </tbody>
...
=== "Level Up Moves"
	...
	| 5 | Encore | - | 100 | 5 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 9 | Wrap | 15 | 90 | 20 | ![normal](../img/types/normal.png) | ![physical](../img/types/physical.png) |
	| 12 | Struggle-bug | 50 | 100 | 20 | ![bug](../img/types/bug.png) | ![special](../img/types/special.png) |
	| 23 | Rock-throw | 50 | 90 | 15 | ![rock](../img/types/rock.png) | ![physical](../img/types/physical.png) |
	| 27 | Gastro-acid | - | 100 | 10 | ![poison](../img/types/poison.png) | ![status](../img/types/status.png) |
	| 31 | Power-trick | - | - | 10 | ![psychic](../img/types/psychic.png) | ![status](../img/types/status.png) |
	| 34 | Shell-smash | - | - | 15 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 42 | Bug-bite | 60 | 100 | 20 | ![bug](../img/types/bug.png) | ![physical](../img/types/physical.png) |
	| 45 | Power-split | - | - | 10 | ![psychic](../img/types/psychic.png) | ![status](../img/types/status.png) |
	| 45 | Guard-split | - | - | 10 | ![psychic](../img/types/psychic.png) | ![status](../img/types/status.png) |
	| 53 | Sticky-web | - | - | 20 | ![bug](../img/types/bug.png) | ![status](../img/types/status.png) |
