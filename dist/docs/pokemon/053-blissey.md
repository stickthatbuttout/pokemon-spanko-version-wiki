<div class="pokemon-attribute-container">
  <img src="../../img/pokemon/blissey.png" width="100"/>
...
<table style="width: 100%">
  <tbody style="width: 100%;">
    <tr style="display: flex; align-items: center;">
      ...
      <td style="border-top: none; width: 70px">255</td>
      <td style="width: 100%; min-width: 450px; border-top: none;">
        <div style="width: 100%;" class="ranking-bar rank-6">
        </div>
      </td>
    </tr>
    <tr style="display: flex; align-items: center;">
...
=== "Level Up Moves"
	...
	| 44 | Egg-bomb | 100 | 75 | 10 | ![normal](../img/types/normal.png) | ![physical](../img/types/physical.png) |
