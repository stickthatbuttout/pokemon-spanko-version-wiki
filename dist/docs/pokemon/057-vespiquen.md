<div class="pokemon-attribute-container">
  <img src="../../img/pokemon/vespiquen.png" width="100"/>
...
<table style="width: 100%">
  <tbody style="width: 100%;">
    ...
    <tr style="display: flex; align-items: center;">
      ...
      <td style="width: 100%; min-width: 450px; border-top: none;">
        <div style="width: 40%;" class="ranking-bar rank-4">
        </div>
      </td>
    </tr>
    <tr style="display: flex; align-items: center;">
...
=== "Level Up Moves"
	...
	| 17 | Defend-order | - | - | 10 | ![bug](../img/types/bug.png) | ![status](../img/types/status.png) |
	| 25 | Power-gem | 80 | 100 | 20 | ![rock](../img/types/rock.png) | ![special](../img/types/special.png) |
	| 29 | Heal-order | - | - | 10 | ![bug](../img/types/bug.png) | ![status](../img/types/status.png) |
	...
	| 45 | Attack-order | 90 | 100 | 15 | ![bug](../img/types/bug.png) | ![physical](../img/types/physical.png) |
	| 53 | Destiny-bond | - | - | 5 | ![ghost](../img/types/ghost.png) | ![status](../img/types/status.png) |
	| 57 | Fell-stinger | 50 | 100 | 25 | ![bug](../img/types/bug.png) | ![physical](../img/types/physical.png) |
